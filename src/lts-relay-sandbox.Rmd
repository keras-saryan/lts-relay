...
lts %>%
    ...
    geom_label(aes(label = paste(participant, "–", time_spent, "days")), colour = "black", position = position_stack(vjust = 0.5), family = fontCustom) +
    coord_polar(theta = "y") +
...
lts <- lts %>%
    ...
    select(stage, participant, language, receipt_date, time_spent, wordchar_ratio_lg, nword_lg, nchar_lg, nword_en, nchar_en)
```
