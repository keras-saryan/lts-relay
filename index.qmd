...
| Jonathan Kane    | Sdefa        | 12 Feb. 2024               |  8 Feb. 2024              | [{{< fa file-pdf >}}](src/sdefa.pdf){target="_blank" title="Download torch (without English translation)"} [{{< fa video >}}](https://www.tumblr.com/mindutme/746399593948921856/sdefa-sdaturday-11){target="_blank" title="Video of Sdefa text (with English translation) on Jonathan's Tumblr"} |
...
[^2]: This should read *yahga* not *yah*. The error is reproduced here to match the torch document.
...
lts <- lts %>%
    ...
    select(stage, participant, language, receipt_date, time_spent, wordchar_ratio_lg, nchar_lg, nword_lg, nchar_en, nword_en) %>%
...
## N characters per words in conlang text
